...
import myphoto from "../Images/photo1.jpg"
import resume from "../files/Pashupati_Nath_singh_Resume.pdf"
...
const About = ({ref,func}) => {
    ...
    return (
        <div className='About-div about section' id='about' ref={ref} onScroll={func}>
            ...
            <h1 className='about-me'>About <span style={{ color: "#B5D9EB" }}>Me</span></h1>
