    ...
    <div className='Tech-Stacks' id="skills">
      ...
      <div className='heading-div'>
        <button className='heading-textbtn'>
          <h1 className='heading'>Technical <span style={{ color: "#B5D9EB" }}>Skills</span></h1>
        </button>
      ...
      <div className='logosofstacks'>
        ...
        <Tooltip hasArrow label="Vercel"  className="tooltip-font skills-card-name" bg={"#f7f0f0"} color={"white"}>
